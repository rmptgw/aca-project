					...
					<div class="bs-component">
						...
						<div class="col-lg-offset-x">
							...
							<p class="bs-component">
								<a
									href="javascript:delete_click('<%=contextName%>/cus.do?act=CUSD&NO=<%=cusNo%>')"
									class="btn btn-danger">삭제</a> <a
									href="javascript:update_click('<%=contextName%>/cus.do?act=CUSUR&NO=<%=cusNo%>')"
									class="btn btn-primary">수정</a> <a
									href="javascript:list_click('<%=contextName%>/cus.do?act=CUSL&page=<%=cpage%>&srch_type=<%=srch_type%>&srch_keyword=<%=srch_keyword%>')"
