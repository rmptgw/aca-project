...
<script type="text/javascript">
	...
	function validation() {
		...
		} else if (document.fm.provCEO.value == '') {
			alert('대표이사를 입력하세요');
			return false;

		} else if (document.fm.provHP.value == '') {
			alert('전화번호를 입력하세요');
			return false;
		} else if (document.fm.provAdd.value == '0') {
			alert('주소를 입력하세요');
			return false;
		} else if (document.fm.provEmail.value == '0') {
			alert('메일을 입력하세요');
			return false;
...
<ul class="nav navbar-nav navbar-right">
									<li><a href="<%=contextName%>/emp.do?act=EMPL">사원관리</a></li>
								</ul>
								<ul class="nav navbar-nav navbar-right">
									<li class="active"><a
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="page-header">
						<h3 id="tables">납품업체 등록</h3>
					</div>
					<div class="bs-component">
						<form name="fm" method=post
							action="<%=contextName%>/prov.do?act=PROVC"
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h3 class="panel-title">납품업체 이름</h3>
								</div>
								<div class="panel-body">
									<input type="text" class="form-control" id="inputEmail"
										name="provName">
